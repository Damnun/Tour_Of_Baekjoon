...
def operation1(a):  # 각 부분 배열의 상하 반전
    n = len(a)
...
def operation2(a):  # 각 부분 배열의 좌우 반전
    n = len(a)
    ans = [[0]*n for _ in range(n)]
    for i in range(n):
        for j in range(n):
...
def operation3(a):  # 각 부분 배열의 90도 시계 방향 회전
    n = len(a)
    ans = [[0]*n for _ in range(n)]
    for i in range(n):
        for j in range(n):
...
def operation4(a):  # 각 부분 배열의 90도 반시계 방향 회전
    n = len(a)
    ans = [[0]*n for _ in range(n)]
    for i in range(n):
        for j in range(n):
...
def operation5(a, l):  # 배열의 상하 반전 (부분 배열을 한 칸으로)
    n = len(a)
    ans = [[0]*n for _ in range(n)]
    sub_size = (1 << l)
...
def operation6(a, l):  # 배열의 좌우 반전 (부분 배열을 한 칸으로)
    n = len(a)
    ans = [[0]*n for _ in range(n)]
    sub_size = (1 << l)
    sub_count = n // sub_size
...
def operation7(a, l):  # 배열의 90도 시계 방향 회전 (부분 배열을 한 칸으로)
    n = len(a)
    ans = [[0]*n for _ in range(n)]
    sub_size = (1 << l)
    sub_count = n // sub_size
...
def operation8(a, l):  # 배열의 90도 반시계 방향 반전 (부분 배열을 한 칸으로)
    n = len(a)
    ans = [[0]*n for _ in range(n)]
    sub_size = (1 << l)
    sub_count = n // sub_size
